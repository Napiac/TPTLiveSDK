...
///缓存管理者
@interface UICommonWebCacheManager : NSObject

/// 缓存方案：URLCache 和 URLProtocol，默认NO 即使用URLCache进行缓存
...
+ (UICommonWebCacheManager *)shareInstance;
